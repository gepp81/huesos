...
$(document).ready(function(){
    ...
    */
    var options = {
        zoom: 4,
        center: new google.maps.LatLng(-35.960223,-65.302734),
        ...
        $.ajax({
            ...
            success : function(data){
                ...
                */
                ...
                for (x in datos){
                    var y = datos[x];
                    var myLatlng = new google.maps.LatLng(y.latitud,y.longitud);
                    var marker = new google.maps.Marker({
                        position: myLatlng,
                        map: map,
                        title:"Ver detalles del registro: " + y.numero_registro,
                        dato:y.numero_registro
                    });
                }
            }
        });

...
--
-- Servidor: localhost
-- Tiempo de generación: 29-07-2011 a las 17:30:44
...
(77, '', '', '', '', '', 'Huesos Aislados', 'Indefinido', 'Infantil (0-11 años)', '', '<25%', '', NULL, 'Ausente', 'No', 'No', 'No', 'Ninguno', 'Ninguno', 'Ninguno', '', 'No', ''),
(111, 'Guillermo', 'ss', 'ss', '', '', 'Huesos Aislados', 'Indefinido', 'Infantil (0-11 años)', '', '<25%', '', NULL, 'Ausente', 'No', 'No', 'No', 'Ninguno', 'Ninguno', 'Ninguno', '', 'No', ''),
(9999, '', '', '', '', '', 'Huesos Aislados', 'Femenino', 'Adulto Joven (20-34 años)', '', '<25%', '', NULL, 'Ausente', 'No', 'No', 'No', 'Ninguno', 'Ninguno', 'Ninguno', '', 'No', ''),
(456456, '', '', '', '', '', 'Huesos Aislados', 'Indefinido', 'Infantil (0-11 años)', '', '<25%', '', NULL, 'Ausente', 'No', 'No', 'No', 'Ninguno', 'Ninguno', 'Ninguno', '', 'No', '');
...
INSERT INTO `inventario_oseo` (`ficha`, `numero_resumen`, `numero_registro`, `sitio`, `acronimo`, `localidad`, `provincia`, `periodo`, `latitud`, `longitud`, `precision`, `dataciones`, `material_asociado`, `sobrehueso`) VALUES
(4, '0009', 9999, '', '', '', '', '', '', '', 'No', 'No', 'No', 'No'),
(5, '536546', 456456, '', '', '', 'hole', '', '', '', 'No', 'No', 'No', 'No'),
(6, 'A001', 111, '', '', '', 'Buenos Aires', 'romano', '', '', 'No', '14C', 'No', 'No'),
(7, '77', 77, '', '', '', 'Catamarca', '', '', '', 'No', 'No', 'No', 'No');
...
(77, '', '', '', '', NULL, '', '', 'Excavación', '', '', '', '', '', ''),
(111, '', '', '', '', NULL, '', '', 'Préstamo', '', '', '', '', '', 'gfhfgh'),
(9999, '8', '8', '8', '8', NULL, '8', '8', 'Excavación', '8', '8', '8', '88', '8', '888'),
(456456, '', '', '', '', NULL, '', '', 'Excavación', '', '', '', '', '', '');
...
CREATE TABLE IF NOT EXISTS `sesiones` (
  `id_sesion` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `dato` text COLLATE utf8_spanish2_ci NOT NULL,

...
if (!isset($_SESSION['nombreusuario'])) {
    ...
    // Las 3 queries.
    $query1 = "INSERT INTO `inventario_oseo` (
    ...
    // inventario arq
    $query2 = "INSERT INTO `inventario_arq` (
                      `id_inventario`,
...
// inventario ubi
    $query3 = "INSERT INTO  `inventario_ubi` (
                `id_inventario`,
                `fecha_ingreso`,`numero_caja`,`sala`,
                `estanteria`,`restos_humano`,`otros_restos`,`forma_ingreso`,
                `fecha_salida`,`res_registro`,`res_conservacion`,`res_digitalizacion`,
                `res_bodegaje`,`observaciones`)
                VALUES(
                        '" . $_POST['numero_registro'] . "',
    ...
    if (conectarDB(array($query1, $query2, $query3))) {
        ...
        $_SESSION['mensaje'] = " No se ha podido introducir el registro.";
    }

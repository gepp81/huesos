...
if ($resultado->num_rows > 0) {
    while ($row = $resultado->fetch_array()) {
        if ($row['latitud'] != '' && $row['longitud'] != '' ){
            $json['datos'][$row['numero_registro']]['ficha'] = $row['ficha'];
            $json['datos'][$row['numero_registro']]['numero_registro'] = $row['numero_registro'];
            $json['datos'][$row['numero_registro']]['latitud'] = $row['latitud'];
            $json['datos'][$row['numero_registro']]['longitud'] = $row['longitud'];
